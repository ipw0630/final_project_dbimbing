...
docker-build:
	...
	@echo '==========================================================='
	@docker build -t dataeng-dibimbing/mysql -f ./docker/Dockerfile.mysql .
	@echo '==========================================================='
...
postgres-create-table:
	...
	@docker exec -it ${POSTGRES_CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DW_DB} -f sql/pet-ddl.sql
	@echo '==========================================================='
...
postgres-ingest-csv:
	...
	@echo 'Ingesting CSV...'
	@echo '_________________________________________'
	@docker exec -it ${POSTGRES_CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DW_DB} -f sql/ingest-pet-adoption.sql
	@echo '==========================================================='
...
postgres-create-warehouse:
	...
	@echo '_________________________________________'
	@docker exec -it ${POSTGRES_CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DB} -f sql/warehouse-pet-ddl.sql
	@echo '==========================================================='
